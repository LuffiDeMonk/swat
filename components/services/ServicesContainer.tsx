    ...
    return (
        <section id='services'>
            ...
            <div className="h-[80vh] -mt-[10vh] relative">
                ...
                <MotionDiv variants={serviceVariants} initial='initial' whileInView='animate' viewport={{ once: true }} className="w-full h-full absolute top-0 py-0.5 right-0 flex flex-col items-end gap-0.5">
                    {
                        Array(4).fill('q').map((_, idx) => (
                            <MotionDiv variants={serviceVariants} className="bg-white bg-opacity-90 h-[25%] p-6 hover:-translate-x-5 w-full lg:w-1/2 transition-transform group" key={idx}>
